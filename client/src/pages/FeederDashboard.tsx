      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          {schedules.map((meal) => {
            const completed =
              (status as any)[
                `meal${meal.mealNumber}Completed`
              ] || 0;
            ...
            return (
              ...
              >
                ...
                <CardHeader
                  className={`bg-gradient-to-r ${meal.color} text-white pb-3`}
                >
                  ...
                  <CardDescription className="text-white/90">
                    {String(meal.hour).padStart(
                      2,
                      "0"
                    )}
                    :
                    {String(meal.minute).padStart(
                      2,
                      "0"
                    )}
                  </CardDescription>
                ...
                <CardContent className="pt-6">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <Button
                      onClick={() =>
                        feedManuallyMutation.mutate({
                          mealNumber:
                            meal.mealNumber,
                        })
                      }
                      className={`${meal.button} text-white`}
                    >
                      Alimentar Agora
                    </Button>
