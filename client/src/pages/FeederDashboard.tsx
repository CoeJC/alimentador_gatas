...
export default function FeederDashboard() {
  ...
  const schedules = [
    { mealNumber: 1, hour: 7, minute: 50 },
    { mealNumber: 2, hour: 10, minute: 0 },
    { mealNumber: 3, hour: 13, minute: 30 },
    { mealNumber: 4, hour: 18, minute: 10 },
    { mealNumber: 5, hour: 21, minute: 0 },
    { mealNumber: 6, hour: 23, minute: 0 },
  ];
    ...
    try {
      ...
      if (json.success) {
        ...
        setStatus({
          ...
          nextMealTime: json.data.nextMealTime || "--:--",
  ...
  const feedManually = async (mealNumber: number) => {
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          {schedules.map((meal) => {
            ...
            const completed =
              status[`meal${meal.mealNumber}Completed` as keyof typeof status] as number;
              ...
              >
                ...
                <CardHeader className="bg-gradient-to-r from-purple-500 to-pink-500 text-white pb-3">
                  ...
                  <CardDescription className="text-purple-100">
                    ...
                    {meal.hour}:{String(meal.minute).padStart(2, "0")}
                ...
                <CardContent className="pt-6">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <Badge
                      className={`text-base py-2 px-4 ${getMealStatusColor(completed)}`}
                    >
                      {getMealStatusText(completed)}
                    </Badge>

                    <Button
                      onClick={() => feedManually(meal.mealNumber)}
